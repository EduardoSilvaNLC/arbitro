export default async function handler(req, res) {
    ...
    const prompt = `You are analyzing two betting site screenshots for NBA player assists O/U markets.
Image 1 = Bet365. Image 2 = Betfair Sportsbook.

Extract odds for assists over/under markets for each player.
